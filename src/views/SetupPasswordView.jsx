...
const SetupPasswordView = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(true);
      setTimeout(() => {
        // 管理者IDなら管理者ページへ、それ以外はスタッフ（ホーム）へ
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4 font-sans">
      <div className="w-full max-w-md animate-in fade-in zoom-in duration-500">
        <div className="glass-card p-8 border border-white/10 shadow-2xl relative overflow-hidden backdrop-blur-3xl">
          ...
          {error && (
            <div className="bg-red-500/10 border border-red-500/20 text-red-400 p-4 rounded-xl flex items-center gap-3 text-xs mb-6 animate-in slide-in-from-top-2 duration-300">
              <AlertCircle size={16} />
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/5 rounded-2xl py-3 pl-12 pr-4 text-sm font-medium focus:outline-none focus:border-blue-500/50 transition-all text-white placeholder:text-slate-600"
                  />
                </div>
              </div>
